...
namespace FastCore.Api.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        /// </summary>
        [HttpDelete("Delete")]
        public async Task<IActionResult> DeleteAsync([FromBody] CategoryVm entity)
        {
            await _categoryApplication.DeleteAsync(entity);
            return Ok();
        }
        ...
        /// </summary>
        [HttpGet("{categoryId}")]
        public async Task<IActionResult> GetItemAsyncAsync([FromBody] int categoryId)
        {
            var result = await _categoryApplication.GetItemAsync(categoryId);
            return Ok(result);
        }
